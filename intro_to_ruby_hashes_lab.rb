...
def monopoly_with_fourth_tier
  monopoly = { 
	  :railroads => {:pieces => 4, :rent_in_dollars => {
	    ...
	    :reading_railroad => {"mortgage_value" => "$100"}, :pennsylvania_railroad => {"mortgage_value" => "$200"}, :b_and_o_railroad => {"mortgage_value" => "$400"}, :shortline_railroad => {"mortgage_value" => "$100"}
	  }},
	}
end
